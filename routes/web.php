...
Route::get('/adaggregation', [AdAggregationController::class, 'getAddatas']);
...
Route::get('/media_update', [MediaUpdateController::class, 'getMedia']);
...
Route::get('/campaign_update', [CampaignUpdateController::class, 'getCampaign']);
...
Route::get('/addata_update', [AddataUpdateController::class, 'getAddata']);
